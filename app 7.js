const practicalWords=[{"word": "passport", "phonetic": "ˈpɑːspɔːt", "meaning": "护照", "example": "May I see your passport?", "exampleZh": "我可以看一下你的护照吗？", "source": "practical"}, {"word": "luggage", "phonetic": "ˈlʌɡɪdʒ", "meaning": "行李", "example": "Where can I leave my luggage?", "exampleZh": "我可以把行李放在哪里？", "source": "practical"}, {"word": "reservation", "phonetic": "ˌrezəˈveɪʃn", "meaning": "预订；预约", "example": "I have a reservation.", "exampleZh": "我有预订。", "source": "practical"}, {"word": "departure", "phonetic": "dɪˈpɑːtʃə", "meaning": "出发；离境", "example": "What time is the departure?", "exampleZh": "几点出发？", "source": "practical"}, {"word": "arrival", "phonetic": "əˈraɪvl", "meaning": "到达；入境", "example": "The arrival time is 8 p.m.", "exampleZh": "到达时间是晚上8点。", "source": "practical"}, {"word": "boarding", "phonetic": "ˈbɔːdɪŋ", "meaning": "登机", "example": "Boarding starts at 6:30.", "exampleZh": "6点30分开始登机。", "source": "practical"}, {"word": "terminal", "phonetic": "ˈtɜːmɪnl", "meaning": "航站楼", "example": "Which terminal do I need?", "exampleZh": "我要去哪个航站楼？", "source": "practical"}, {"word": "customs", "phonetic": "ˈkʌstəmz", "meaning": "海关", "example": "Where is customs?", "exampleZh": "海关在哪里？", "source": "practical"}, {"word": "security", "phonetic": "sɪˈkjʊərəti", "meaning": "安检；安全", "example": "Where is the security check?", "exampleZh": "安检在哪里？", "source": "practical"}, {"word": "delayed", "phonetic": "dɪˈleɪd", "meaning": "延误的", "example": "My flight is delayed.", "exampleZh": "我的航班延误了。", "source": "practical"}, {"word": "cancelled", "phonetic": "ˈkænsəld", "meaning": "被取消的", "example": "Has the flight been cancelled?", "exampleZh": "航班被取消了吗？", "source": "practical"}, {"word": "transfer", "phonetic": "trænsˈfɜː", "meaning": "转机；换乘", "example": "Where do I transfer?", "exampleZh": "我在哪里转机/换乘？", "source": "practical"}, {"word": "platform", "phonetic": "ˈplætfɔːm", "meaning": "站台", "example": "Which platform is it?", "exampleZh": "是哪个站台？", "source": "practical"}, {"word": "entrance", "phonetic": "ˈentrəns", "meaning": "入口", "example": "Where is the entrance?", "exampleZh": "入口在哪里？", "source": "practical"}, {"word": "exit", "phonetic": "ˈeksɪt", "meaning": "出口", "example": "Where is the nearest exit?", "exampleZh": "最近的出口在哪里？", "source": "practical"}, {"word": "direction", "phonetic": "dəˈrekʃn", "meaning": "方向；路线", "example": "Can you show me the direction?", "exampleZh": "你能给我指一下方向吗？", "source": "practical"}, {"word": "receipt", "phonetic": "rɪˈsiːt", "meaning": "收据；小票", "example": "Can I have the receipt?", "exampleZh": "可以给我小票吗？", "source": "practical"}, {"word": "change", "phonetic": "tʃeɪndʒ", "meaning": "零钱；找零；更换", "example": "Do you have change?", "exampleZh": "你有零钱吗？", "source": "practical"}, {"word": "cash", "phonetic": "kæʃ", "meaning": "现金", "example": "Can I pay in cash?", "exampleZh": "我可以付现金吗？", "source": "practical"}, {"word": "charger", "phonetic": "ˈtʃɑːdʒə", "meaning": "充电器", "example": "Do you have a charger?", "exampleZh": "你有充电器吗？", "source": "practical"}, {"word": "battery", "phonetic": "ˈbætəri", "meaning": "电池；电量", "example": "My battery is low.", "exampleZh": "我的手机快没电了。", "source": "practical"}, {"word": "signal", "phonetic": "ˈsɪɡnəl", "meaning": "信号", "example": "There is no signal here.", "exampleZh": "这里没有信号。", "source": "practical"}, {"word": "menu", "phonetic": "ˈmenjuː", "meaning": "菜单", "example": "Could I see the menu?", "exampleZh": "我可以看一下菜单吗？", "source": "practical"}, {"word": "order", "phonetic": "ˈɔːdə", "meaning": "点餐；订单", "example": "I am ready to order.", "exampleZh": "我可以点餐了。", "source": "practical"}, {"word": "allergy", "phonetic": "ˈælədʒi", "meaning": "过敏", "example": "I have a peanut allergy.", "exampleZh": "我对花生过敏。", "source": "practical"}, {"word": "spicy", "phonetic": "ˈspaɪsi", "meaning": "辣的", "example": "Is this very spicy?", "exampleZh": "这个很辣吗？", "source": "practical"}, {"word": "vegetarian", "phonetic": "ˌvedʒəˈteəriən", "meaning": "素食的；素食者", "example": "Do you have a vegetarian option?", "exampleZh": "你们有素食选择吗？", "source": "practical"}, {"word": "bill", "phonetic": "bɪl", "meaning": "账单", "example": "Could we have the bill?", "exampleZh": "可以结账吗？", "source": "practical"}, {"word": "refund", "phonetic": "ˈriːfʌnd", "meaning": "退款", "example": "Can I get a refund?", "exampleZh": "我可以退款吗？", "source": "practical"}, {"word": "exchange", "phonetic": "ɪksˈtʃeɪndʒ", "meaning": "换货；兑换", "example": "Can I exchange this?", "exampleZh": "这个可以换吗？", "source": "practical"}, {"word": "size", "phonetic": "saɪz", "meaning": "尺寸；尺码", "example": "Do you have a larger size?", "exampleZh": "有大一码的吗？", "source": "practical"}, {"word": "pharmacy", "phonetic": "ˈfɑːməsi", "meaning": "药店", "example": "Where is the nearest pharmacy?", "exampleZh": "最近的药店在哪里？", "source": "practical"}, {"word": "medicine", "phonetic": "ˈmedɪsɪn", "meaning": "药", "example": "I need some medicine.", "exampleZh": "我需要一些药。", "source": "practical"}, {"word": "fever", "phonetic": "ˈfiːvə", "meaning": "发烧", "example": "I have a fever.", "exampleZh": "我发烧了。", "source": "practical"}, {"word": "pain", "phonetic": "peɪn", "meaning": "疼痛", "example": "I have pain here.", "exampleZh": "我这里疼。", "source": "practical"}, {"word": "appointment", "phonetic": "əˈpɔɪntmənt", "meaning": "预约", "example": "I have an appointment at three.", "exampleZh": "我三点有预约。", "source": "practical"}, {"word": "emergency", "phonetic": "ɪˈmɜːdʒənsi", "meaning": "紧急情况", "example": "This is an emergency.", "exampleZh": "这是紧急情况。", "source": "practical"}, {"word": "address", "phonetic": "əˈdres", "meaning": "地址", "example": "Could you write down the address?", "exampleZh": "你可以把地址写下来吗？", "source": "practical"}, {"word": "elevator", "phonetic": "ˈelɪveɪtə", "meaning": "电梯", "example": "Where is the elevator?", "exampleZh": "电梯在哪里？", "source": "practical"}, {"word": "towel", "phonetic": "ˈtaʊəl", "meaning": "毛巾", "example": "Can I have another towel?", "exampleZh": "可以再给我一条毛巾吗？", "source": "practical"}, {"word": "blanket", "phonetic": "ˈblæŋkɪt", "meaning": "毯子", "example": "Could I get a blanket?", "exampleZh": "可以给我一条毯子吗？", "source": "practical"}, {"word": "available", "phonetic": "əˈveɪləbl", "meaning": "可用的；有空的", "example": "Is this room available?", "exampleZh": "这个房间有空吗？", "source": "practical"}, {"word": "included", "phonetic": "ɪnˈkluːdɪd", "meaning": "包含在内的", "example": "Is breakfast included?", "exampleZh": "包含早餐吗？", "source": "practical"}, {"word": "deposit", "phonetic": "dɪˈpɒzɪt", "meaning": "押金", "example": "How much is the deposit?", "exampleZh": "押金多少钱？", "source": "practical"}, {"word": "booking", "phonetic": "ˈbʊkɪŋ", "meaning": "预订", "example": "I need to change my booking.", "exampleZh": "我需要修改预订。", "source": "practical"}, {"word": "laundry", "phonetic": "ˈlɔːndri", "meaning": "洗衣；洗衣房", "example": "Where is the laundry room?", "exampleZh": "洗衣房在哪里？", "source": "practical"}, {"word": "delivery", "phonetic": "dɪˈlɪvəri", "meaning": "配送；快递", "example": "When will the delivery arrive?", "exampleZh": "快递什么时候到？", "source": "practical"}, {"word": "schedule", "phonetic": "ˈʃedjuːl", "meaning": "日程；安排", "example": "What is the schedule for today?", "exampleZh": "今天的安排是什么？", "source": "practical"}, {"word": "understand", "phonetic": "ˌʌndəˈstænd", "meaning": "理解；听懂", "example": "I do not understand.", "exampleZh": "我听不懂。", "source": "practical"}, {"word": "repeat", "phonetic": "rɪˈpiːt", "meaning": "重复", "example": "Could you repeat that?", "exampleZh": "你可以重复一遍吗？", "source": "practical"}, {"word": "slowly", "phonetic": "ˈsləʊli", "meaning": "慢慢地", "example": "Could you speak more slowly?", "exampleZh": "你可以说慢一点吗？", "source": "practical"}, {"word": "explain", "phonetic": "ɪkˈspleɪn", "meaning": "解释", "example": "Could you explain that again?", "exampleZh": "你可以再解释一遍吗？", "source": "practical"}, {"word": "recommend", "phonetic": "ˌrekəˈmend", "meaning": "推荐", "example": "What do you recommend?", "exampleZh": "你推荐什么？", "source": "practical"}, {"word": "choose", "phonetic": "tʃuːz", "meaning": "选择", "example": "Which one should I choose?", "exampleZh": "我应该选哪一个？", "source": "practical"}, {"word": "probably", "phonetic": "ˈprɒbəbli", "meaning": "大概；可能", "example": "I will probably arrive late.", "exampleZh": "我可能会晚到。", "source": "practical"}, {"word": "nearby", "phonetic": "ˌnɪəˈbaɪ", "meaning": "附近的", "example": "Is there a café nearby?", "exampleZh": "附近有咖啡店吗？", "source": "practical"}, {"word": "local", "phonetic": "ˈləʊkl", "meaning": "当地的", "example": "Is this a local train?", "exampleZh": "这是本地列车吗？", "source": "practical"}, {"word": "crowded", "phonetic": "ˈkraʊdɪd", "meaning": "拥挤的", "example": "It is very crowded today.", "exampleZh": "今天非常拥挤。", "source": "practical"}, {"word": "quiet", "phonetic": "ˈkwaɪət", "meaning": "安静的", "example": "Is there a quieter room?", "exampleZh": "有更安静的房间吗？", "source": "practical"}];
...
const freshState=()=>({version:3,name:'',xp:0,learned:[],seen:[],review:{},wrong:[],completedScenes:[],tasks:{date:'',vocab:false,scene:false,listen:false},streak:0,lastStudy:''});
let state=JSON.parse(localStorage.getItem('zxgs_state')||'null')||freshState();

const wordKey=w=>String(w||'').trim().toLowerCase();
const DAY=24*60*60*1000;
const reviewIntervals=[1,3,7,14,30,90];

// Migrate older saves without deleting genuine learning progress.
if(!state.version){
  if(String(state.name||'').toLowerCase()==='lesley' && (state.learned||[]).length===0){ state=freshState(); }
  else { state.version=2; }
}
if((state.version||0)<3){
  state.seen=Array.from(new Set([...(state.seen||[]),...(state.learned||[]).map(wordKey)]));
  state.review=state.review||{};
  for(const w of (state.wrong||[])){
    const k=wordKey(w.word);
    if(k && !state.review[k]) state.review[k]={...w,stage:0,due:Date.now()+DAY};
  }
  state.version=3;
  localStorage.setItem('zxgs_state',JSON.stringify(state));
}
state.seen=state.seen||[];
state.review=state.review||{};

let vocab=[...practicalWords,...fallbackWords], currentLesson=[], lessonIndex=0, lessonKind='vocab';

function save(){localStorage.setItem('zxgs_state',JSON.stringify(state));updateUI()}
function hasSeen(word){return state.seen.includes(wordKey(word))}
function markSeen(word){
 const k=wordKey(word);
 if(k && !state.seen.includes(k)) state.seen.push(k);
}
function isLearned(word){const k=wordKey(word);return state.learned.some(x=>wordKey(x)===k)}
function addLearned(word){
 if(!isLearned(word)) state.learned.push(word);
}
function putReview(w,correct,fromNew=false){
 if(!w||!w.word)return;
 const k=wordKey(w.word);
 const old=state.review[k]||{...w,stage:0,due:Date.now()+DAY};
 let stage=Number(old.stage||0);
 if(correct){
   // A newly learned word is considered finished; it won't return to normal learning.
   // First optional memory check is deliberately far away (14 days), not tomorrow.
   stage=fromNew?3:Math.min(stage+1,reviewIntervals.length-1);
 }else{
   stage=0;
 }
 const days=reviewIntervals[stage]||90;
 state.review[k]={...w,stage,due:Date.now()+days*DAY};
}
function dueReviewWords(){
 const now=Date.now();
 return Object.values(state.review||{}).filter(r=>Number(r.due||0)<=now);
}
...
async function loadData(){
 try{
  ...
  if(out.length>1000){const seen=new Set(practicalWords.map(x=>x.word.toLowerCase()));vocab=[...practicalWords,...out.filter(x=>!seen.has(String(x.word).toLowerCase()))].slice(0,3000);localStorage.setItem('zxgs_vocab_count',String(vocab.length));toast('3000 高频词库已载入 ✨')}
...
function renderReview(){
 const list=dueReviewWords().slice(0,30);
 const upcoming=Object.values(state.review||{}).filter(r=>Number(r.due||0)>Date.now()).length;
 document.getElementById('reviewList').innerHTML=list.length?list.map(w=>`<div class="review-item"><div><b>${w.word}</b><br><span>${w.meaning}</span></div><button class="speaker" onclick="speak('${String(w.word).replace(/'/g,"\\'")}')">🔊</button><span>今天到期</span></div>`).join(''):`<div style="padding:30px;text-align:center;color:#7d86a4">今天没有到期复习词 ✨<br><small>${upcoming?`还有 ${upcoming} 个词已安排在以后复习。`:'继续学新词就好。'}</small></div>`;
}
...
function startLesson(kind){
 ...
 // New-learning modes NEVER pull a word that has already been completed once.
 // Wrong words leave the new-word stream too; they only return through scheduled review.
 let pool=vocab.filter(w=>!hasSeen(w.word));

 if(kind==='review'){
   pool=dueReviewWords();
   if(!pool.length){toast('今天没有到期复习词，放心学新词吧 ✨');nav('review');return}
 }else{
   const practicalPool=practicalWords.filter(w=>!hasSeen(w.word));
   if(practicalPool.length){
     const practicalKeys=new Set(practicalPool.map(x=>wordKey(x.word)));
     pool=[...practicalPool,...pool.filter(w=>!practicalKeys.has(wordKey(w.word)))];
   }
 }

 currentLesson=(pool.length?pool:[]).slice(0,10);lessonIndex=0;
 if(!currentLesson.length){toast('这一阶段的新词已经学完啦 🎉');nav('tasks');return}
 document.getElementById('lessonMode').textContent=kind==='listen'?'听力挑战':kind==='speak'?'口语开口':kind==='review'?'到期复习':'单词学习';
 document.getElementById('lessonTitle').textContent=kind==='listen'?'出国实用听力 · 每题都是新内容':kind==='speak'?'出国实用口语 · 每题都是新内容':kind==='review'?'只复习今天到期的词':'今日 10 个全新出国实用词';
...
function answerMeaning(btn,chosen,correct){document.querySelectorAll('.choice').forEach(b=>b.disabled=true);const ok=chosen===correct;btn.classList.add(ok?'correct':'wrong'); if(ok){setTimeout(()=>markLearned(correct,true),550)}else{state.xp=Math.max(0,state.xp-1);setTimeout(()=>markLearned(correct,false),650)}}
function answerChoice(btn,chosen,correct){answerMeaning(btn,chosen,correct)}
function markLearned(word,known){
 const w=currentLesson[lessonIndex];
 if(w){
   markSeen(w.word);
   if(known){
     addLearned(w.word);
     state.xp+=5;
     putReview(w,true,lessonKind!=='review');
   }else{
     state.wrong.push(w);
     putReview(w,false,false);
   }
 }
 studyTouch(); save();lessonIndex++;renderLesson();
}
function finishLesson(){
 state.tasks[lessonKind==='listen'?'listen':'vocab']=true;state.xp+=10;save();toast('本轮学完！这些词不会再回到新词课 ✨');nav('tasks');
}
...
const coverStart=document.getElementById('coverStartBtn');if(coverStart)coverStart.onclick=()=>state.name?nav('map'):nav('onboarding');
...
document.getElementById('startReview').onclick=()=>startLesson('review');
